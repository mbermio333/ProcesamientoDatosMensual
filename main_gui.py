        ...
        try:
            ...
            for base in nombres_bases:
                ...
                for tipo, archivos, titulo in [
                    ...
                    # Insertar imágenes según el tipo
                    if tipo == "FM":
                        self.insertar_imagenes(ws, fila_actual + 4, tipo="FM")
                    elif tipo == "TV":
                        self.insertar_imagenes(ws, fila_actual + 2, tipo="TV")
                    ...
                    self.colorear_celdas_por_valor(ws, fila_inicio_datos, fila_fin_datos, tipo, columnas_colorear)
